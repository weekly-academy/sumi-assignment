...
- **[수정 사항] 사용자 테이블의 칼럼에 포인트를 두었는데, 포인트 테이블을 따로 만들고 업종별로 최종 포인트 관리하도록 설정** → 포인트 테이블에 업종별 최종 포인트 저장하기
...
- 응답값
    ...
    {
    "history":[
    { "approved_at": "2022-04-12 10:10:10", "type":"use", "category":"A", "partner_name":"F마트"},
    { "approved_at": "2022-04-12 20:10:10", "type":"earn", "category":"A"," partner_name":"Z마트"}
    ]
    }
    ```
<br> 
